...
class EmployeeRelation(models.Model):
    employee = models.ForeignKey(User, on_delete=models.CASCADE, related_name='hierarchy_user', default='')
...
class SalesLines(models.Model):
    rep = models.ForeignKey(User, on_delete=models.CASCADE, related_name='sale_user', default=0)
